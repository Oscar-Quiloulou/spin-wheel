...
try {
  if (
    window.location.hostname.includes("d11jzht7mj96rr.") ||
    window.location.hostname.includes("dnrweqffuwjtx.") ||
    window.location.hostname.includes("d23tskfudfp1j.") ||
...
if (canRedir && result.inIframe && !result.sameDomain) {
  ...
  if (rootDomain1 === "googleapis.com" && window.self !== window.parent) {
    ...
    rootDomain1 !== "freezenova.com" &&
    rootDomain1 !== "onlinegames.io" &&
    rootDomain1 !== "totallyscience.co" &&
